    ...
    private static class Helper {
        ...
        public final class SSLSettingsListener implements SettingsListener {
            ...
            public void settingChanged(String name, String newValue, String oldValue) {
                ...
                if (name.equals(SSLSettings.WINDOWS_KEYSTORE)) {

                } else if (name.equals(SSLSettings.KEYSTORE) || name.equals(SSLSettings.KEYSTORE_PASSWORD)) {
                    try {
        ...
        public SoapUISSLSocketFactory initSocketFactory() throws KeyStoreException, NoSuchAlgorithmException,
            ...
            if (settings.getBoolean(SSLSettings.WINDOWS_KEYSTORE)) {
                keyStore = KeyStore.getInstance("Windows-MY");
                return new SoapUISSLSocketFactory(keyStore, null);
            } else {
